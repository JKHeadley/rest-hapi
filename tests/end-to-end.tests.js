                  ...
                  return server.register({
                    ...
                    options: {
                      ...
                      .then(function (response) {
                        let now = new Date();
                        now.setUTCMinutes(0, 0, 0);
                        let log1 = response[0].result.docs[3];
                        log1.date.setUTCMinutes(0, 0, 0);
                  ...
                  return server.register({
                    ...
                    options: {
                      ...
                      .then(function (response) {
                        let now = new Date();
                        now.setUTCMinutes(0, 0, 0);
                        let log1 = response[0].result.docs[8];
                        let log2 = response[0].result.docs[9];
                        log1.date.setUTCMinutes(0, 0, 0);
                        log2.date.setUTCMinutes(0, 0, 0);
                        t.deepEqual(log1.method, 'DELETE', 'method correct');
                        t.deepEqual(log1.action, 'Delete', 'action correct');
                  ...
                  return server.register({
                    ...
                    options: {
                      ...
                      .then(function (response) {
                        let now = new Date();
                        now.setUTCMinutes(0, 0, 0);
                        let log1 = response[0].result.docs[13];
                        let log2 = response[0].result.docs[14];
                        let log3 = response[0].result.docs[15];
                        let log4 = response[0].result.docs[16];
                        let log5 = response[0].result.docs[17];
                        let log6 = response[0].result.docs[18];
                        let log7 = response[0].result.docs[19];
                        let log8 = response[0].result.docs[20];
                        log1.date.setUTCMinutes(0, 0, 0);
                        log2.date.setUTCMinutes(0, 0, 0);
