      ...
      .then(function() {
        return t.test('duplicate field tests', function (t) {
          ...
          //duplicate fields populate upon creation
                ...
                return t.test('duplicate fields populate upon creation', function (t) {
                  ...
                  return server.register({
                    ...
                    options: {
                      ...
                      //<editor-fold desc="Assert">
                      .then(function (response) {
                        t.deepEquals(response[0].result.docs[0].titleName, 'User', 'role:name field populated for user 1');
                        t.deepEquals(response[0].result.docs[0].summary, roles[0].description, 'role:description field populated for user 1');
                        t.deepEquals(response[0].result.docs[0].businessName, 'testBiz1', 'role:companyName field populated for user 1');
                        t.deepEquals(response[0].result.docs[1].titleName, 'Admin', 'role:name field populated for user 2');
                        t.deepEquals(response[0].result.docs[1].summary, roles[1].description, 'role:description field populated for user 2');
                        t.deepEquals(response[0].result.docs[1].businessName, 'testBiz2', 'role:companyName field populated for user 2');
                        t.deepEquals(response[0].result.docs[2].titleName, 'Admin', 'role:name field populated for user 3');
                        t.deepEquals(response[0].result.docs[2].summary, roles[1].description, 'role:description field populated for user 3');
                        t.deepEquals(response[0].result.docs[2].businessName, 'testBiz2', 'role:companyName field populated for user 3');
                        t.deepEquals(response[0].result.docs[3].titleName, 'SuperAdmin', 'role:name field populated for user 4');
                        t.deepEquals(response[0].result.docs[3].summary, roles[2].description, 'role:description field populated for user 4');
                        t.deepEquals(response[0].result.docs[3].businessName, undefined, 'role:companyName field not populated for user 4');
                        t.deepEquals(response[1].result.docs[0].userEmail, users[0].email, 'user:email field populated for user profile');
                      })
                      //</editor-fold>
              ...
              .then(function () {
                return t.test('duplicated fields track original field upon update', function (t) {
                  //<editor-fold desc="Arrange">
                  const RestHapi = require('../rest-hapi');
                  const server = new Hapi.Server();
                  server.connection(RestHapi.config.server.connection);
              ...
              .then(function () {
                return t.test('duplicated fields don\'t track original field when tracking is disabled', function (t) {
                  //<editor-fold desc="Arrange">
                  const RestHapi = require('../rest-hapi');
                  const server = new Hapi.Server();
                  server.connection(RestHapi.config.server.connection);
