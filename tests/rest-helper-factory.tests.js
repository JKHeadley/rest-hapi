...
test('rest-helper-factory.generateListEndpoint', function(t) {
  ...
  t.test(
    ...
    sinon.test(function(t) {
      ...
      var handlerHelperStub = this.stub(
      ...
      var joiMongooseHelperStub = this.stub(
  ...
  t.test(
    ...
    sinon.test(function(t) {
      ...
      var responseSchema = Joi.alternatives()
        .try(
          Joi.object({
            docs: Joi.array()
              .items(readModel)
...
test('rest-helper-factory.generateAssociationAddManyEndpoint', function(t) {
  ...
  t.test(
    ...
    sinon.test(function(t) {
      ...
      var payloadValidation1 = Joi.array()
        .items(
          Joi.object({ test: 'test' })
            .unknown()
            .keys({
      ...
      payloadValidation1 = Joi.alternatives()
        ...
        .label('undefined_many')
        .required()
      var payloadValidation2 = Joi.array()
