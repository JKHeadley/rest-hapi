  ...
  var Model = sql.define('user', {
    ...
    classMethods: {
      associate: function (models) {
        ...
        Model.belongsTo(models.imageFile, {foreignKey: "profileImageId", as: "profileImage"});
        Model.routeOptions.associations.profileImage.include = {model: models.imageFile, as: "profileImage"};

        Model.belongsToMany(models.group, {through: 'userGroup', as: "groups"});
        Model.routeOptions.associations.groups.include = {model: models.group, as: "groups"};

        Model.belongsToMany(models.permission, {through: 'userPermission', as: "permissions"});
      ...
      routeOptions: {
        ...
        extraEndpoints: [
          ...
          function (server, model, options, Log) {
            ...
            Log.note("Generating Create No Auth endpoint for" + tableName);
          ...
          function (server, model, options, Log) {
            ...
            Log.note("Generating Password Update endpoint for " + tableName);
          ...
          function (server, model, options, Log) {//NOTE: This could be a security risk as it allows anyone to check the existence of a user email/account
            ...
            Log.note("Generating Check User Email endpoint for " + tableName);
          ...
          function (server, model, options, Log) {//NOTE: This could be a security risk as it allows anyone to check the existence of a user email/account
            ...
            Log.note("Generating Check User Activation endpoint for " + tableName);
          ...
          function (server, model, options, Log) {
            ...
            Log.note("Generating Activate User Account endpoint for " + tableName);
          ...
          function (server, model, options, Log) {
            ...
            Log.note("Generating Email Link GET endpoint for " + tableName);
          ...
          function (server, model, options, Log) {
            ...
            Log.note("Generating Email Link POST endpoint for " + tableName);
          ...
          function (server, model, options, Log) {
            ...
            Log.note("Generating Email Link PUT endpoint for " + tableName);
      ...
      extraReadModelAttributes: {
        ...
        userId: Joi.string().allow(null).optional(), //HACK: not sure where this comes from.
      }
    }
  });
